...
REM Define Output file path
set Out_Path=%CD%\binaries\vision_sdk\bin\tda3xx-rvp\sbl_boot
set Tools_path=%CD%\..\ti_components\drivers\starterware_01_06_00_16\bootloader\Tools
set Tools_CRC_path=%CD%\..\ti_components\drivers\starterware_01_06_00_16\bootloader\Tools\crc_multicore_image

REM set calculate_crc=1
...
set App_IPU1_CPU0=%CD%\binaries\vision_sdk\bin\tda3xx-rvp\vision_sdk_ipu1_0_%profile%.xem4
set App_IPU1_CPU1=%CD%\binaries\vision_sdk\bin\tda3xx-rvp\vision_sdk_ipu1_1_%profile%.xem4
set App_DSP1=%CD%\binaries\vision_sdk\bin\tda3xx-rvp\vision_sdk_c66xdsp_1_%profile%.xe66
set App_DSP2=%CD%\binaries\vision_sdk\bin\tda3xx-rvp\vision_sdk_c66xdsp_2_%profile%.xe66
set App_EVE1=%CD%\binaries\vision_sdk\bin\tda3xx-rvp\vision_sdk_arp32_1_%profile%.xearp32F
...
"%Tools_path%\multicore_image_generator\v2\MulticoreImageGen.exe" LE %Dev_ID% %Out_Path%\AppImage_LE %IPU1_CPU0% %App_IPU1_CPU0_RPRC% %IPU1_CPU1% %App_IPU1_CPU1_RPRC% %DSP1_CPU% %App_DSP1_RPRC% %DSP2_CPU% %App_DSP2_RPRC% %EVE1_CPU% %App_EVE1_RPRC% %IPU1_CPU_SMP% %App_IPU1_RPRC%
"%Tools_path%\multicore_image_generator\v2\MulticoreImageGen.exe" BE %Dev_ID% %Out_Path%\AppImage_BE %IPU1_CPU0% %App_IPU1_CPU0_RPRC% %IPU1_CPU1% %App_IPU1_CPU1_RPRC% %DSP1_CPU% %App_DSP1_RPRC% %DSP2_CPU% %App_DSP2_RPRC% %EVE1_CPU% %App_EVE1_RPRC% %IPU1_CPU_SMP% %App_IPU1_RPRC%
)

if defined calculate_crc (
REM Remove AppImage_BE
del %Out_Path%\AppImage_BE
"%Tools_CRC_path%\crc_multicore_image.exe" %Out_Path%\AppImage_LE %Out_Path%\AppImage_BE
)

copy %Out_Path%\AppImage_LE %Out_Path%\AppImage

REM copy %Out_Path%\AppImage G:\
