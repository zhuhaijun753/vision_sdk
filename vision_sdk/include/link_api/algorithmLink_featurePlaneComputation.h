 ...
 * \defgroup ALGORITHM_LINK_FEATUREPLANECOMPUTATION  \
 *           Feature Plane Computation v1 API
...
#ifndef ALGORITHM_LINK_FEATUREPLANECOMPUTATION_H_
#define ALGORITHM_LINK_FEATUREPLANECOMPUTATION_H_
 ...
 *   \addtogroup ALGORITHM_LINK_FEATURE_PLANE_COMPUTE_CMD \
 *               Feature Plane Compute v1 Control Commands
 *   @{
 *
 *******************************************************************************
 */
...
static inline void AlgorithmLink_FeatureComputation_Init(
    AlgorithmLink_FeaturePlaneComputationCreateParams *pPrm)
{
    memset(pPrm, 0, sizeof(AlgorithmLink_FeaturePlaneComputationCreateParams));
