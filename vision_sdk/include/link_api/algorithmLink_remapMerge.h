 ...
 * \defgroup ALGORITHM_LINK_REMAPMERGE  Remap merge API
 *
 *
...
#ifndef ALGORITHM_LINK_REMAPMERGE_H_
#define ALGORITHM_LINK_REMAPMERGE_H_
 ...
 */
    memset(pPrm, 0, sizeof(AlgorithmLink_RemapMergeCreateParams));
