 ...
 *******************************************************************************
*/
#define SYSTEM_MAKE_LINK_ID(p, x) (((UInt32)((p) & 0xFU) << 8U) | ((x) & 0x000000FFU))
...
#define SYSTEM_LINK_ID_MAKE_NOTIFY_TYPE(dest_p, src_p, t)       \
    ( SYSTEM_MAKE_LINK_ID((dest_p), (src_p)) | ( (UInt32)( (t) & 0xFU ) << 12U) )
 ...
 *******************************************************************************
 *
 * \brief IPU1_0 & IPU2 System Link - used for non-link specific proc level
 *        communication
 *
 *******************************************************************************
*/
...
*/
#ifdef IPU_PRIMARY_CORE_IPU2
#define IPU1_0_LINK(x)          SYSTEM_MAKE_LINK_ID(SYSTEM_PROC_IPU2 , (x))
#define IPU2_LINK(x)            SYSTEM_MAKE_LINK_ID(SYSTEM_PROC_IPU1_0 , (x))
#endif
/**
 *******************************************************************************
 *
...
typedef enum
{
    ...
    SYSTEM_LINK_ID_GRPX_SRC_0 = 22,
    /**< Null source link - can be used as a source link providing
     *   dummy data */

    SYSTEM_LINK_ID_GRPX_SRC_1 = 23,
    /**< Null source link - can be used as a source link providing
     *   dummy data */

    SYSTEM_LINK_ID_DUP_0 = 24,
    /**< Dup Link - Duplicate frames and provides multiple outputs */

    SYSTEM_LINK_ID_DUP_1 = 25,
    /**< Dup Link - Duplicate frames and provides multiple outputs */

    SYSTEM_LINK_ID_DUP_2 = 26,
    /**< Dup Link - Duplicate frames and provides multiple outputs */

    SYSTEM_LINK_ID_DUP_3 = 27,
    /**< Dup Link - Duplicate frames and provides multiple outputs */

    SYSTEM_LINK_ID_DUP_4 = 28,
    /**< Dup Link - Duplicate frames and provides multiple outputs */

    SYSTEM_LINK_ID_GATE_0 = 29,
    /**< Gate Link - Acts a on/off switch and allows partial data
         flow to exist */

    SYSTEM_LINK_ID_GATE_1 = 30,
    /**< Gate Link - Acts a on/off switch and allows partial data
         flow to exist */

    SYSTEM_LINK_ID_GATE_2 = 31,
    /**< Gate Link - Acts a on/off switch and allows partial data
         flow to exist */

    SYSTEM_LINK_ID_GATE_3 = 32,
    /**< Gate Link - Acts a on/off switch and allows partial data
         flow to exist */

    SYSTEM_LINK_ID_SYNC_0 = 33,
    /**< Sync Link - creates a composite frame by composing multiple incoming
         Frames */

    SYSTEM_LINK_ID_SYNC_1 = 34,
    /**< Sync Link - creates a composite frame by composing multiple incoming
         Frames */

    SYSTEM_LINK_ID_SYNC_2 = 35,
    /**< Sync Link - creates a composite frame by composing multiple incoming
         Frames */

    SYSTEM_LINK_ID_SYNC_3 = 36,
    /**< Sync Link - creates a composite frame by composing multiple incoming
         Frames */

    SYSTEM_LINK_ID_MERGE_0 = 37,
    /**< Merge Link - Merge different input queue frames & provide them as
     *   single output source. Channel numbering is sequential wrt to
     *   input queues */

    SYSTEM_LINK_ID_MERGE_1 = 38,
    /**< Merge Link - Merge different input queue frames & provide them as
     *   single output source. Channel numbering is sequential wrt to
     *   input queues */

    SYSTEM_LINK_ID_MERGE_2 = 39,
    /**< Merge Link - Merge different input queue frames & provide them as
     *   single output source. Channel numbering is sequential wrt to
     *   input queues */

    SYSTEM_LINK_ID_MERGE_3 = 40,
    /**< Merge Link - Merge different input queue frames & provide them as
     *   single output source. Channel numbering is sequential wrt to
     *   input queues */

    SYSTEM_LINK_ID_MERGE_4 = 41,
    /**< Merge Link - Merge different input queue frames & provide them as
     *   single output source. Channel numbering is sequential wrt to
     *   input queues */


    SYSTEM_LINK_ID_SELECT_0 = 42,
    /**< Select Link enables configurable mapping of specific channels
     *   to be sent out in multiple queues */

    SYSTEM_LINK_ID_SELECT_1 = 43,
    /**< Select Link enables configurable mapping of specific channels
     *   to be sent out in multiple queues */

    SYSTEM_LINK_ID_ALG_0 = 44,
    /**< Algorithm link Id */

    SYSTEM_LINK_ID_ALG_1 = 45,
    /**< Algorithm link Id */

    SYSTEM_LINK_ID_ALG_2 = 46,
    /**< Algorithm link Id */

    SYSTEM_LINK_ID_ALG_3 = 47,
    /**< Algorithm link Id */

    SYSTEM_LINK_ID_ALG_4 = 48,
    /**< Algorithm link Id */

    SYSTEM_LINK_ID_ALG_5 = 49,
    /**< Algorithm link Id */

    SYSTEM_LINK_ID_ALG_6 = 50,
    /**< Algorithm link Id */

    SYSTEM_LINK_ID_ALG_7 = 51,
    /**< Algorithm link Id */

    SYSTEM_LINK_ID_NULL_SRC_0 = 52,
    /**< Null source link - can be used as a source link providing
     *   dummy data */

    SYSTEM_LINK_ID_AVB_RX = 53,
    ...
    SYSTEM_LINK_ID_RTI_0 = 54,
    /* RTI link - only on TDA3x, on all cores except EVE/M4_1 */

    SYSTEM_LINK_COMMON_LINKS_MAX_ID = 55
    /**< Common Links - Max Id */
