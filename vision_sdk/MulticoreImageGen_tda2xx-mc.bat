...
set Out_Path=%CD%\binaries\vision_sdk\bin\tda2xx-mc\sbl_boot
set Tools_path=%CD%\..\ti_components\drivers\starterware_01_06_00_16\bootloader\Tools
...
set App_MPU_CPU0=%CD%\binaries\vision_sdk\bin\tda2xx-mc\vision_sdk_a15_0_$profile.xa15fg
set App_MPU_CPU1=
REM App_MPU_SMP is to define MPU SMP application, To enable SMP mode - remove "App_MPU_CPU0" & set "APP_MPU_SMP"
REM set APP_MPU_SMP=%CD%\binaries\vision_sdk\bin\tda2xx-mc\vision_sdk_a15_0_$profile.xa15fg
set App_IPU1_CPU0=%CD%\binaries\vision_sdk\bin\tda2xx-mc\vision_sdk_ipu1_0_%profile%.xem4
set App_IPU1_CPU1=%CD%\binaries\vision_sdk\bin\tda2xx-mc\vision_sdk_ipu1_1_%profile%.xem4
REM App_IPU1_CPU_SMP is to define the IPU SMP application
set App_IPU1_CPU_SMP=
REM set App_IPU2_CPU0=%CD%\binaries\vision_sdk\bin\tda2xx-mc\vision_sdk_ipu2_%profile%.xem4
REM set App_IPU2_CPU1=
REM App_IPU2_CPU_SMP is to define the IPU SMP application
REM set App_IPU2_CPU_SMP=%CD%\binaries\vision_sdk\bin\tda2xx-mc\vision_sdk_ipu2_%profile%.xem4
set App_DSP1=%CD%\binaries\vision_sdk\bin\tda2xx-mc\vision_sdk_c66xdsp_1_%profile%.xe66
set App_DSP2=%CD%\binaries\vision_sdk\bin\tda2xx-mc\vision_sdk_c66xdsp_2_%profile%.xe66
set App_EVE1=%CD%\binaries\vision_sdk\bin\tda2xx-mc\vision_sdk_arp32_1_%profile%.xearp32F
set App_EVE2=%CD%\binaries\vision_sdk\bin\tda2xx-mc\vision_sdk_arp32_2_%profile%.xearp32F
set App_EVE3=%CD%\binaries\vision_sdk\bin\tda2xx-mc\vision_sdk_arp32_3_%profile%.xearp32F
set App_EVE4=%CD%\binaries\vision_sdk\bin\tda2xx-mc\vision_sdk_arp32_4_%profile%.xearp32F
