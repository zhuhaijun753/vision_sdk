...
# Radar
radar_INCLUDE = $(vision_sdk_PATH)/examples/tda2xx/src/radar_fusion/
...
#OpenCL
opencl_INCLUDE = $(OpenCL_PATH)/include
...
#sbl
sbl_INCLUDE =  $(starterware_PATH)/include/$(ISA)/tda2xx $(starterware_PATH)/bootloader/sbl/include $(starterware_PATH)/system_config/tda2xx_common $(starterware_PATH)/system_config/$(ISA)/tda2xx $(starterware_PATH)/utils/uart_console $(starterware_PATH)/include/$(ISA)
export sbl_INCLUDE
endif
