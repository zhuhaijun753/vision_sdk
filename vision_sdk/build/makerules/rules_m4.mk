...
BSPLIB_PATH +=$(DEST_ROOT)/lib/$(PLATFORM)/$(ISA)/$(PROFILE_$(CORE))/fat_lib.aem4
ifeq ($(PLATFORM), $(filter $(PLATFORM), tda3xx-evm tda2xx-evm tda3xx-rvp))
BSPLIB_PATH += $(DEST_ROOT)/lib/$(PLATFORM)/$(ISA)/$(PROFILE_$(CORE))/sbl_lib.aem4
endif
BSPLIB_PATH +=$(DEST_ROOT)/lib/$(PLATFORM)/$(ISA)/$(PROFILE_$(CORE))/safety_lib.aem4
...
LIB_PATHS += $(scene_obstruction_detect_PATH)/modules/ti_scene_obstruction_detect/lib/sceneObstructionDetect_algo.aem4
