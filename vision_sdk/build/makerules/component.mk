...
ifeq ($(TDA3X_3DSRV_V2W_GEN),yes)
 vision_sdk_CFLAGS += -DTDA3X_3DSRV_V2W_GEN
endif
...
ifeq ($(ALG_CRC_INCLUDE),yes)
  vision_sdk_CFLAGS += -DALG_CRC_INCLUDE
endif
...
ifeq ($(RADAR_INCLUDE),yes)
  vision_sdk_CFLAGS += -DRADAR_INCLUDE
endif

ifeq ($(ALG_SV_INCLUDE),yes)
  vision_sdk_CFLAGS += -DALG_SV_INCLUDE
endif
