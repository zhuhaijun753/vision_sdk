...
LNKFLAGS_INTERNAL_COMMON =  --reread_libs --warn_sections -q -e=_c_int00 --silicon_version=6600 --rom_model --zero_init=off
ifeq ($(A15_TARGET_OS), Linux)
...
LIB_PATHS += $(vlib_PATH)/packages/ti/vlib/lib/vlib_cn.ae66
LIB_PATHS += $(vlib_PATH)/packages/ti/vlib/lib/common.lib
LIB_PATHS += $(lane_detect_PATH)/modules/ti_lane_detection/lib/lane_detection_algo.lib
LIB_PATHS += $(gpe_PATH)/modules/ti_ground_plane_estimation/lib/ti_ground_plane_estimation_algo.lib
LIB_PATHS += $(sfm_PATH)/modules/ti_sfm/lib/sfm_algo.lib
LIB_PATHS += $(clr_PATH)/modules/ti_circular_light_recognition/lib/ti_circular_light_recognition_algo.lib
LIB_PATHS += $(fcw_PATH)/modules/ti_forward_collision_warning/lib/ti_forward_collision_warning_algo.lib
LIB_PATHS += $(object_detect_PATH)/modules/ti_object_detection/lib/object_detection_algo.lib
LIB_PATHS += $(object_classification_PATH)/modules/ti_object_classification/lib/object_classification_algo.lib
LIB_PATHS += $(clr_PATH)/dmautils/libs/dsp_dmautils.lib
LIB_PATHS += $(stereo_postprocess_PATH)/modules/ti_stereovision/lib/stereovision_algo.lib
LIB_PATHS += $(scene_obstruction_detect_PATH)/modules/ti_scene_obstruction_detect/lib/sceneObstructionDetect_algo.lib
LIB_PATHS += $(mathlib_PATH)/packages/ti/mathlib/lib/mathlib.ae66
LIB_PATHS += $(DEST_ROOT)/lib/$(PLATFORM)/$(ISA)/$(PROFILE_$(CORE))/starterware_hal.ae66
LIB_PATHS += $(DEST_ROOT)/lib/$(PLATFORM)/$(ISA)/$(PROFILE_$(CORE))/safety_lib.ae66
LIB_PATHS += $(DEST_ROOT)/lib/$(PLATFORM)/$(ISA)/$(PROFILE_$(CORE))/utils_platform.ae66
