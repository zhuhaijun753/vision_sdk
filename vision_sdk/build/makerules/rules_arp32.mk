...
LIB_PATHS += $(evealg_PATH)/apps/clahe/algo/lib/$(PROFILE_$(CORE))/libeveClahe.eve.lib
...
LIB_PATHS += $(DEST_ROOT)/lib/$(PLATFORM)/$(ISA)/$(PROFILE_$(CORE))/starterware_hal.aearp32F
LIB_PATHS += $(DEST_ROOT)/lib/$(PLATFORM)/$(ISA)/$(PROFILE_$(CORE))/safety_lib.aearp32F
