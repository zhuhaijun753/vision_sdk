...
LIB_PATHS += $(DEST_ROOT)/lib/$(PLATFORM)/$(ISA)/$(PROFILE_$(CORE))/fat_lib.$(LIBEXT)
...
$(EXE_NAME) : $(OBJ_PATHS_ASM) $(OBJ_PATHS) $(OBJ_PATHS_CPP) $(LIB_PATHS) $(LNKCMD_FILE) $(OBJDIR)/$(CFG_COBJ_XDC)
	...
	$(LNK) $(_LNKFLAGS) $(OBJ_PATHS_ASM) $(OBJ_PATHS) $(OBJ_PATHS_CPP) $(VISION_SDK_LIB) $(VISION_SDK_ALG_PLUGINS_LIB) $(OPENCVAPP_LIBS_a15_0) $(OPENCLAPP_LIBS_a15_0) -T $(LNKCMD_FILE) $(LNK_LIBS) -Map=$@.map -o $@
	$(ECHO) \#
	$(ECHO) \# $@ created.
	$(ECHO) \#
