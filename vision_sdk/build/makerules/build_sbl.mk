...
SBL_TDA2XX_OPTIONS= $(SBL_COMMON_OPTIONS) PLATFORM=tda2xx EMIFMODE=SINGLE_EMIF_512MB FORCE_OPPMODE=TRUE OPPMODE=opp_nom PM_OPTIMIZE=TRUE
SBL_TDA2EX_OPTIONS= $(SBL_COMMON_OPTIONS) PLATFORM=tda2ex EMIFMODE=SINGLE_EMIF_512MB FORCE_OPPMODE=TRUE OPPMODE=opp_nom PM_OPTIMIZE=TRUE
SBL_TDA2XX_MC_OPTIONS= $(SBL_COMMON_OPTIONS) PLATFORM=tda2xx-mc EMIFMODE=SINGLE_EMIF_512MB FORCE_OPPMODE=TRUE OPPMODE=opp_nom PM_OPTIMIZE=TRUE
SBL_TDA3XX_OPTIONS= $(SBL_COMMON_OPTIONS)
ifeq ($(ECC_FFI_INCLUDE), no)
SBL_TDA3XX_OPTIONS+= SBL_CONFIG=disable_safety
endif
...
ifeq ($(VSDK_BOARD_TYPE),TDA2XX_EVM)
	...
	$(MAKE) -C $(starterware_PATH) sbl BOOTMODE=sd  $(SBL_TDA2XX_OPTIONS) DEVICE_TYPE_HS=yes
endif
ifeq ($(VSDK_BOARD_TYPE),TDA2XX_MC)
	$(MAKE) -C $(starterware_PATH) sbl BOOTMODE=sd  $(SBL_TDA2XX_MC_OPTIONS)
	$(MAKE) -C $(starterware_PATH) sbl BOOTMODE=sd  $(SBL_TDA2XX_MC_OPTIONS) DEVICE_TYPE_HS=yes
endif
ifeq ($(VSDK_BOARD_TYPE),TDA2EX_EVM)
	$(MAKE) -C $(starterware_PATH) sbl BOOTMODE=sd  $(SBL_TDA2EX_OPTIONS)
	$(MAKE) -C $(starterware_PATH) sbl BOOTMODE=sd  $(SBL_TDA2EX_OPTIONS) DEVICE_TYPE_HS=yes
endif

sbl_qspi:
ifeq ($(VSDK_BOARD_TYPE),TDA2XX_EVM)
	$(MAKE) -C $(starterware_PATH) sbl BOOTMODE=qspi  $(SBL_TDA2XX_OPTIONS)
	$(MAKE) -C $(starterware_PATH) sbl BOOTMODE=qspi  $(SBL_TDA2XX_OPTIONS) DEVICE_TYPE_HS=yes
...
ifeq ($(VSDK_BOARD_TYPE),TDA2XX_MC)
	...
	$(MAKE) -C $(starterware_PATH) sbl BOOTMODE=qspi  $(SBL_TDA2XX_MC_OPTIONS) DEVICE_TYPE_HS=yes
...
ifeq ($(VSDK_BOARD_TYPE),TDA2EX_EVM)
	...
	$(MAKE) -C $(starterware_PATH) sbl BOOTMODE=qspi $(SBL_TDA2EX_OPTIONS) DEVICE_TYPE_HS=yes
...
ifeq ($(VSDK_BOARD_TYPE),TDA2XX_EVM)
	...
	$(MAKE) -C $(starterware_PATH) sbl BOOTMODE=nor  $(SBL_TDA2XX_OPTIONS) DEVICE_TYPE_HS=yes
	$(MAKE) -C $(starterware_PATH) nor_flash_writer  $(SBL_TDA2XX_OPTIONS)
endif
ifeq ($(VSDK_BOARD_TYPE),TDA2EX_EVM)
	$(MAKE) -C $(starterware_PATH) sbl BOOTMODE=nor  $(SBL_TDA2EX_OPTIONS)
	$(MAKE) -C $(starterware_PATH) sbl BOOTMODE=nor  $(SBL_TDA2EX_OPTIONS) DEVICE_TYPE_HS=yes
	$(MAKE) -C $(starterware_PATH) nor_flash_writer  $(SBL_TDA2EX_OPTIONS)
endif
...
ifeq ($(PLATFORM),$(filter $(PLATFORM), tda2ex-evm))
	$(MAKE) -C $(starterware_PATH) sbl_all_clean  $(SBL_TDA2EX_OPTIONS)
	$(MAKE) -C $(starterware_PATH) qspiFlashWriter_clean  $(SBL_TDA2EX_OPTIONS)
	$(MAKE) -C $(starterware_PATH) nor_flash_writer_clean  $(SBL_TDA2EX_OPTIONS)
endif
ifeq ($(PLATFORM),$(filter $(PLATFORM), tda3xx-evm))
	$(MAKE) -C $(starterware_PATH) sbl_all_clean  $(SBL_TDA3XX_OPTIONS)
	$(MAKE) -C $(starterware_PATH) qspiFlashWriter_clean  $(SBL_TDA3XX_OPTIONS)
	$(MAKE) -C $(starterware_PATH) nor_flash_writer_clean  $(SBL_TDA3XX_OPTIONS)
endif
