...
function getMemSegmentDefinition_external(core)
{
    ...
    EVE1_DATA_SIZE              =   2*MB - 128*KB;
    IPU1_1_CODE_SIZE            =   2*MB - 32*KB;
    IPU1_1_DATA_SIZE            =   3*MB + 758*KB;
    IPU1_0_CODE_SIZE            =   5*MB - 384*KB;
    IPU1_0_DATA_SIZE            =  10*MB;
    DSP1_CODE_SIZE              = 792*KB;
    DSP1_DATA_SIZE              =   3*MB + 274*KB;
    SR1_FRAME_BUFFER_SIZE       =  35*MB;
    ...
    SR1_BUFF_ECC_ASIL_ADDR     = DSP1_DATA_ADDR             + DSP1_DATA_SIZE;
