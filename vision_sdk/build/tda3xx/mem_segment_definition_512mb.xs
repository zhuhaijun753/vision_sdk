...
function getMemSegmentDefinition_external(core)
{
    ...
    {
        /* when HCF is enabled we need more SR0 space
         * Reducing DDR3_BASE_SIZE_0 will increase space for SR0
         */
        DDR3_BASE_SIZE_0        = 500*MB;
    }
    ...
    IPU1_1_DATA_SIZE            =  12*MB;
    IPU1_0_CODE_SIZE            = 5.5*MB;
    ...
    else
    {
        ...
        SR1_FRAME_BUFFER_SIZE       = 352*MB - (SR1_BUFF_ECC_ASIL_SIZE + SR1_BUFF_ECC_QM_SIZE + SR1_BUFF_NON_ECC_ASIL_SIZE);
    }

    if(java.lang.System.getenv("TDA3X_3DSRV_V2W_GEN")=="yes")
    {
        /*
         *  The TDA3X 3D SRV View 2 world generation function needs more than 30 MB of IPU1_0_CODE_SIZE
         */
        IPU1_0_CODE_SIZE            = 40*MB;
        SR1_FRAME_BUFFER_SIZE       = SR1_FRAME_BUFFER_SIZE - 34.5*MB;
    }
    ...
    NDK_DATA_ADDR              = EVE1_DATA_ADDR             + EVE1_DATA_SIZE;
