...
function updateScriptVars(printEnable)
{
 //<edit this> <start>
    ...
    baseDir = "Z:\\vsdk\\vision_sdk\\binaries\\vision_sdk\\bin\\tda2ex-evm\\"
    releaseMode = 1;
    A15_0_en = 1;
    IP1_0_en = 1;
    IP1_1_en = 1;
...
function connectTargets()
{
    ...
    if(!disableGels)
    {
        ...
        try
        {
            dsA15_0.expression.evaluate("DRA72x_PAD_VisionAll_Config()");
        }
        catch(e)
        {
        ...
        try
        {
            dsA15_0.expression.evaluate("DRA72x_MULTICORE_EnableAllCores()");
        }
        catch(e)
        {
            print("Some error in GEL execution for Multicore Enable");
        ...
        try
        {
            dsA15_0.expression.evaluate("TDA2Ex_PAD_VisionAll_Config()");
        }
        catch(e)
        {
            print("Some error in GEL execution for Multicore Enable");
