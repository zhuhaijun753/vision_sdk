...
set Sbl_Elf_Path=%STARTERWAREDIRNAME%\binary\sbl_qspi%OPPMODE%\bin\tda2xx
set Sbl_Out_Path=%CD%\qspi_tda2xx
set Sbl_Out_Path_hs=%CD%\qspi_tda2xx_hs
...
copy %STARTERWAREDIRNAME%\binary\qspiFlashWriter\bin\tda2xx\qspiFlashWriter_m4_%profile%.xem4 %Sbl_Out_Path%\
