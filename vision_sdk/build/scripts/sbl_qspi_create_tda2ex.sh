...
export Sbl_Elf_Path=$STARTERWAREDIRNAME/binary/sbl_qspi$OPPMODE/bin/tda2ex
export Sbl_Elf_Path_hs=$STARTERWAREDIRNAME/binary/sbl_qspi$OPPMODE\_hs/bin/tda2ex
export Sbl_Out_Path=$PWD/qspi_tda2ex
export Sbl_Out_Path_hs=$PWD/qspi_tda2ex_hs
...
cp $STARTERWAREDIRNAME/binary/qspiFlashWriter/bin/tda2ex/qspiFlashWriter_m4_$profile.xem4 $Sbl_Out_Path/
