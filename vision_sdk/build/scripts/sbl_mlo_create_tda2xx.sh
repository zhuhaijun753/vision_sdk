...
export Sbl_Elf_Path=$STARTERWAREDIRNAME/binary/sbl_sd$OPPMODE/bin/tda2xx
export Sbl_Elf_Path_hs=$STARTERWAREDIRNAME/binary/sbl_sd$OPPMODE\_hs/bin/tda2xx
export Sbl_Out_Path=$PWD/mlo_tda2xx
export Sbl_Out_Path_hs=$PWD/mlo_tda2xx_hs
