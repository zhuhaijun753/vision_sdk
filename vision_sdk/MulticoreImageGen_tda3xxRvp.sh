...
# Define Output file path
export Out_Path=$PWD/binaries/vision_sdk/bin/tda3xx-rvp/sbl_boot
export Tools_path=$PWD/../ti_components/drivers/starterware_01_06_00_16/bootloader/Tools
export Tools_CRC_path=$PWD/../ti_components/drivers/starterware_01_06_00_16/bootloader/Tools/crc_multicore_image

#export calculate_crc=0
...
export App_IPU1_CPU0=$PWD/binaries/vision_sdk/bin/tda3xx-rvp/vision_sdk_ipu1_0_$profile.xem4
export App_IPU1_CPU1=$PWD/binaries/vision_sdk/bin/tda3xx-rvp/vision_sdk_ipu1_1_$profile.xem4
export App_DSP1=$PWD/binaries/vision_sdk/bin/tda3xx-rvp/vision_sdk_c66xdsp_1_$profile.xe66
export App_DSP2=$PWD/binaries/vision_sdk/bin/tda3xx-rvp/vision_sdk_c66xdsp_2_$profile.xe66
export App_EVE1=$PWD/binaries/vision_sdk/bin/tda3xx-rvp/vision_sdk_arp32_1_$profile.xearp32F
...
# Generate MulticoreImage Gen
    "$Tools_path/multicore_image_generator/tda3xx/MulticoreImageGen" LE $Dev_ID $Out_Path/AppImage_LE $IPU1_CPU0 $App_IPU1_CPU0_RPRC $IPU1_CPU1 $App_IPU1_CPU1_RPRC $DSP1_CPU $App_DSP1_RPRC $DSP2_CPU $App_DSP2_RPRC $EVE1_CPU $App_EVE1_RPRC $IPU1_CPU_SMP $App_IPU1_RPRC
    "$Tools_path/multicore_image_generator/tda3xx/MulticoreImageGen" BE $Dev_ID $Out_Path/AppImage_BE $IPU1_CPU0 $App_IPU1_CPU0_RPRC $IPU1_CPU1 $App_IPU1_CPU1_RPRC $DSP1_CPU $App_DSP1_RPRC $DSP2_CPU $App_DSP2_RPRC $EVE1_CPU $App_EVE1_RPRC $IPU1_CPU_SMP $App_IPU1_RPRC
fi
...
"$Tools_CRC_path/crc_multicore_image" $Out_Path/AppImage_LE $Out_Path/AppImage_BE
fi
