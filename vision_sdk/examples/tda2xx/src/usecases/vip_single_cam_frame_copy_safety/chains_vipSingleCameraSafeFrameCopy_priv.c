...
Void chains_vipSingleCameraSafeFrameCopy_SetLinkId(chains_vipSingleCameraSafeFrameCopyObj *pObj){
       ...
       pObj->Alg_SafeFrameCopyLinkID        = A15_0_LINK (SYSTEM_LINK_ID_ALG_0);
...
Void chains_vipSingleCameraSafeFrameCopy_SetPrms(chains_vipSingleCameraSafeFrameCopyObj *pObj){
       (pObj->Alg_SafeFrameCopyPrm).baseClassCreate.size  = sizeof(AlgorithmLink_SafeFrameCopyCreateParams);
       (pObj->Alg_SafeFrameCopyPrm).baseClassCreate.algId  = ALGORITHM_LINK_A15_ALG_SAFEFRAMECOPY;
}
...
Void chains_vipSingleCameraSafeFrameCopy_ConnectLinks(chains_vipSingleCameraSafeFrameCopyObj *pObj){
       ...
       pObj->IPCIn_A15_0_IPU1_0_0Prm.outQueParams.nextLink = pObj->Alg_SafeFrameCopyLinkID;
       pObj->Alg_SafeFrameCopyPrm.inQueParams.prevLinkId = pObj->IPCIn_A15_0_IPU1_0_0LinkID;
       pObj->Alg_SafeFrameCopyPrm.inQueParams.prevLinkQueId = 0;

       //Alg_SafeFrameCopy -> IPCOut_A15_0_IPU1_0_0
       pObj->Alg_SafeFrameCopyPrm.outQueParams.nextLink = pObj->IPCOut_A15_0_IPU1_0_0LinkID;
       pObj->IPCOut_A15_0_IPU1_0_0Prm.inQueParams.prevLinkId = pObj->Alg_SafeFrameCopyLinkID;
...
Int32 chains_vipSingleCameraSafeFrameCopy_Create(chains_vipSingleCameraSafeFrameCopyObj *pObj, Void *appObj){
       ...
       chains_vipSingleCameraSafeFrameCopy_SetLinkId(pObj);
       chains_vipSingleCameraSafeFrameCopy_ResetLinkPrms(pObj);

       chains_vipSingleCameraSafeFrameCopy_SetPrms(pObj);
       chains_vipSingleCameraSafeFrameCopy_SetAppPrms(pObj, appObj);

       chains_vipSingleCameraSafeFrameCopy_ConnectLinks(pObj);
       ...
       status = System_linkCreate(pObj->Alg_SafeFrameCopyLinkID, &pObj->Alg_SafeFrameCopyPrm, sizeof(pObj->Alg_SafeFrameCopyPrm));
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);
...
Int32 chains_vipSingleCameraSafeFrameCopy_Start(chains_vipSingleCameraSafeFrameCopyObj *pObj){
       ...
       status = System_linkStart(pObj->Alg_SafeFrameCopyLinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);
...
Int32 chains_vipSingleCameraSafeFrameCopy_Stop(chains_vipSingleCameraSafeFrameCopyObj *pObj){
       ...
       status = System_linkStop(pObj->Alg_SafeFrameCopyLinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);
...
Int32 chains_vipSingleCameraSafeFrameCopy_Delete(chains_vipSingleCameraSafeFrameCopyObj *pObj){
       ...
       status = System_linkDelete(pObj->Alg_SafeFrameCopyLinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);
...
Void chains_vipSingleCameraSafeFrameCopy_printBufferStatistics(chains_vipSingleCameraSafeFrameCopyObj *pObj){
       ...
       System_linkPrintBufferStatistics(pObj->Alg_SafeFrameCopyLinkID);
...
Void chains_vipSingleCameraSafeFrameCopy_printStatistics(chains_vipSingleCameraSafeFrameCopyObj *pObj){
       ...
       System_linkPrintStatistics(pObj->Alg_SafeFrameCopyLinkID);
