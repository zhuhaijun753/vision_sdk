                                    ...
                                    Void *appData)
{
    chains_issMultCaptIspDewarpSv_DisplayAppObj *pObj =
        (chains_issMultCaptIspDewarpSv_DisplayAppObj *)appData;
                    ...
                    chains_issMultCaptIspDeWarp3dSvObj *pUcObj, Void *appObj)
{
    ...
    setSyncParams(&pUcObj->Sync_dewarpPrm, pUcObj->IssCapturePrm.numCh, 35U);
 ...
 *******************************************************************************
*/
static Void chains_issMultCaptIspDeWarp3dSv_StartApp(chains_issMultCaptIspDewarpSv_DisplayAppObj *pObj)
{
 ...
 *******************************************************************************
*/
Void Chains_issMultCaptIspDewarp3dSv_Display(Chains_Ctrl *chainsCfg)
{
    Int32 status;
    char ch;
     ...
     */
    chains_issMultCaptIspDeWarp3dSv_FreeBufs(&chainsObj);
