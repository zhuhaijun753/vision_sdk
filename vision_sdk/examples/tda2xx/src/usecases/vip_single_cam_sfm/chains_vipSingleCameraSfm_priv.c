...
Void chains_vipSingleCameraSfm_SetLinkId(chains_vipSingleCameraSfmObj *pObj){
       ...
       pObj->Alg_SfmLinkID                  = DSP1_LINK (SYSTEM_LINK_ID_ALG_1);
...
Void chains_vipSingleCameraSfm_ConnectLinks(chains_vipSingleCameraSfmObj *pObj){
       ...
       //IPCIn_DSP1_EVE1_1 -> Alg_Sfm
       pObj->IPCIn_DSP1_EVE1_1Prm.outQueParams.nextLink = pObj->Alg_SfmLinkID;
       pObj->Alg_SfmPrm.inQueParams.prevLinkId = pObj->IPCIn_DSP1_EVE1_1LinkID;
       pObj->Alg_SfmPrm.inQueParams.prevLinkQueId = 0;

       //Alg_Sfm -> Merge_alg
       pObj->Alg_SfmPrm.outQueParams.nextLink = pObj->Merge_algLinkID;
       pObj->Merge_algPrm.inQueParams[1].prevLinkId = pObj->Alg_SfmLinkID;
...
Int32 chains_vipSingleCameraSfm_Create(chains_vipSingleCameraSfmObj *pObj, Void *appObj){
       ...
       chains_vipSingleCameraSfm_SetLinkId(pObj);
       chains_vipSingleCameraSfm_ResetLinkPrms(pObj);

       chains_vipSingleCameraSfm_SetPrms(pObj);
       chains_vipSingleCameraSfm_SetAppPrms(pObj, appObj);

       chains_vipSingleCameraSfm_ConnectLinks(pObj);
