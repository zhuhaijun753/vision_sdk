...
Void chains_vipSingleCameraAnalytics2_SetLinkId(chains_vipSingleCameraAnalytics2Obj *pObj){
       ...
       pObj->IPCIn_EVE1_IPU1_0_2LinkID      = EVE1_LINK (SYSTEM_LINK_ID_IPC_IN_2);
       pObj->Alg_SparseOpticalFlowLinkID    = EVE1_LINK (SYSTEM_LINK_ID_ALG_2);
       pObj->IPCOut_EVE1_DSP2_2LinkID       = EVE1_LINK (SYSTEM_LINK_ID_IPC_OUT_2);
       ...
       pObj->Alg_ImagePreProcessLinkID      = EVE1_LINK (SYSTEM_LINK_ID_ALG_1);
       ...
       pObj->Alg_LaneDetectLinkID           = DSP2_LINK (SYSTEM_LINK_ID_ALG_4);
       ...
       pObj->Alg_ClrLinkID                  = DSP2_LINK (SYSTEM_LINK_ID_ALG_3);
       pObj->IPCOut_IPU1_0_EVE1_2LinkID     = IPU1_0_LINK (SYSTEM_LINK_ID_IPC_OUT_2);
       ...
       pObj->Sync_FcwLinkID                 = DSP2_LINK (SYSTEM_LINK_ID_SYNC_1);
       pObj->Alg_FcwLinkID                  = DSP2_LINK (SYSTEM_LINK_ID_ALG_2);
       pObj->Merge_algLinkID                = DSP2_LINK (SYSTEM_LINK_ID_MERGE_2);
       pObj->Sync_algLinkID                 = DSP2_LINK (SYSTEM_LINK_ID_SYNC_2);
       pObj->Alg_ObjectDrawLinkID           = DSP2_LINK (SYSTEM_LINK_ID_ALG_5);
...
Void chains_vipSingleCameraAnalytics2_ResetLinkPrms(chains_vipSingleCameraAnalytics2Obj *pObj){
       ...
       IpcLink_CreateParams_Init(&pObj->IPCIn_EVE1_IPU1_0_2Prm);
       AlgorithmLink_SparseOpticalFlow_Init(&pObj->Alg_SparseOpticalFlowPrm);
       IpcLink_CreateParams_Init(&pObj->IPCOut_EVE1_DSP2_2Prm);
...
Void chains_vipSingleCameraAnalytics2_ConnectLinks(chains_vipSingleCameraAnalytics2Obj *pObj){
       ...
       pObj->IPCOut_IPU1_0_EVE1_4Prm.outQueParams.nextLink = pObj->IPCIn_EVE1_IPU1_0_2LinkID;
       pObj->IPCIn_EVE1_IPU1_0_2Prm.inQueParams.prevLinkId = pObj->IPCOut_IPU1_0_EVE1_4LinkID;
       pObj->IPCIn_EVE1_IPU1_0_2Prm.inQueParams.prevLinkQueId = 0;

       //IPCIn_EVE1_IPU1_0_2 -> Alg_SparseOpticalFlow
       pObj->IPCIn_EVE1_IPU1_0_2Prm.outQueParams.nextLink = pObj->Alg_SparseOpticalFlowLinkID;
       pObj->Alg_SparseOpticalFlowPrm.inQueParams.prevLinkId = pObj->IPCIn_EVE1_IPU1_0_2LinkID;
       pObj->Alg_SparseOpticalFlowPrm.inQueParams.prevLinkQueId = 0;

       //Alg_SparseOpticalFlow -> IPCOut_EVE1_DSP2_2
       pObj->Alg_SparseOpticalFlowPrm.outQueParams.nextLink = pObj->IPCOut_EVE1_DSP2_2LinkID;
       pObj->IPCOut_EVE1_DSP2_2Prm.inQueParams.prevLinkId = pObj->Alg_SparseOpticalFlowLinkID;
       pObj->IPCOut_EVE1_DSP2_2Prm.inQueParams.prevLinkQueId = 0;

       //IPCOut_EVE1_DSP2_2 -> IPCIn_DSP2_EVE1_3
       pObj->IPCOut_EVE1_DSP2_2Prm.outQueParams.nextLink = pObj->IPCIn_DSP2_EVE1_3LinkID;
       pObj->IPCIn_DSP2_EVE1_3Prm.inQueParams.prevLinkId = pObj->IPCOut_EVE1_DSP2_2LinkID;
       ...
       //Merge_Fcw -> Sync_Fcw
       pObj->Merge_FcwPrm.outQueParams.nextLink = pObj->Sync_FcwLinkID;
       pObj->Sync_FcwPrm.inQueParams.prevLinkId = pObj->Merge_FcwLinkID;
       ...
       pObj->Alg_ObjectDrawPrm.outQueParams.nextLink = pObj->IPCOut_DSP2_IPU1_0_0LinkID;
       pObj->IPCOut_DSP2_IPU1_0_0Prm.inQueParams.prevLinkId = pObj->Alg_ObjectDrawLinkID;
       ...
       pObj->IPCIn_IPU1_0_DSP2_1Prm.outQueParams.nextLink = pObj->Display_VideoLinkID;
       pObj->Display_VideoPrm.inQueParams.prevLinkId = pObj->IPCIn_IPU1_0_DSP2_1LinkID;
...
Int32 chains_vipSingleCameraAnalytics2_Create(chains_vipSingleCameraAnalytics2Obj *pObj, Void *appObj){
       ...
       status = System_linkCreate(pObj->IPCIn_EVE1_IPU1_0_2LinkID, &pObj->IPCIn_EVE1_IPU1_0_2Prm, sizeof(pObj->IPCIn_EVE1_IPU1_0_2Prm));
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);
       ...
       status = System_linkCreate(pObj->IPCOut_EVE1_DSP2_2LinkID, &pObj->IPCOut_EVE1_DSP2_2Prm, sizeof(pObj->IPCOut_EVE1_DSP2_2Prm));
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);
...
Int32 chains_vipSingleCameraAnalytics2_Start(chains_vipSingleCameraAnalytics2Obj *pObj){
       ...
       status = System_linkStart(pObj->IPCOut_EVE1_DSP2_2LinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);

       status = System_linkStart(pObj->Alg_SparseOpticalFlowLinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);

       status = System_linkStart(pObj->IPCIn_EVE1_IPU1_0_2LinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);
...
Int32 chains_vipSingleCameraAnalytics2_Stop(chains_vipSingleCameraAnalytics2Obj *pObj){
       ...
       status = System_linkStop(pObj->IPCOut_EVE1_DSP2_2LinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);

       status = System_linkStop(pObj->Alg_SparseOpticalFlowLinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);

       status = System_linkStop(pObj->IPCIn_EVE1_IPU1_0_2LinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);
...
Int32 chains_vipSingleCameraAnalytics2_Delete(chains_vipSingleCameraAnalytics2Obj *pObj){
       ...
       status = System_linkDelete(pObj->IPCOut_EVE1_DSP2_2LinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);

       status = System_linkDelete(pObj->Alg_SparseOpticalFlowLinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);

       status = System_linkDelete(pObj->IPCIn_EVE1_IPU1_0_2LinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);
...
Void chains_vipSingleCameraAnalytics2_printBufferStatistics(chains_vipSingleCameraAnalytics2Obj *pObj){
       ...
       Task_sleep(500);
       System_linkPrintBufferStatistics(pObj->IPCIn_EVE1_IPU1_0_2LinkID);
       System_linkPrintBufferStatistics(pObj->Alg_SparseOpticalFlowLinkID);
       System_linkPrintBufferStatistics(pObj->IPCOut_EVE1_DSP2_2LinkID);
       Task_sleep(500);
...
Void chains_vipSingleCameraAnalytics2_printStatistics(chains_vipSingleCameraAnalytics2Obj *pObj){
       ...
       Task_sleep(500);
       System_linkPrintStatistics(pObj->IPCIn_EVE1_IPU1_0_2LinkID);
       System_linkPrintStatistics(pObj->Alg_SparseOpticalFlowLinkID);
       System_linkPrintStatistics(pObj->IPCOut_EVE1_DSP2_2LinkID);
       Task_sleep(500);
