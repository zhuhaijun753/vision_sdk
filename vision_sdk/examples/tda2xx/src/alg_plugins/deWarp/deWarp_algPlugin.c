...
static Int32 AlgLinkDeWarpControl(void *pObj, void *pControlParams)
{
    ...
    switch(pAlgLinkControlPrm->controlCmd)
    {
        ...
        case ALG_LINK_DEWARP_CMD_GET_TASKPRI:
            /*
             *  TBD:    The BIOS task APIs are being directly called here since
             *          the BSP osal APIs are not available.
             *          Make sure these are replaced with the BSP osal APIs once
             *          available.
             */
            pTaskPriority = (AlgLink_DeWarpTaskPriority*)pControlParams;
            pTaskPriority->taskPriority = Task_getPri(Task_self());
            break;
        case ALG_LINK_DEWARP_CMD_SET_TASKPRI:
             ...
             */
            pTaskPriority = (AlgLink_DeWarpTaskPriority*)pControlParams;
            Task_setPri(Task_self(),pTaskPriority->taskPriority);
            break;
        default:
            break;
    }
                                                            ...
                                                            *pViewParams)
{
    ...
    {
        pVideoPrevOutFrame = pAlgObj->pPrevOutBuffer;
    }
    else
    {
