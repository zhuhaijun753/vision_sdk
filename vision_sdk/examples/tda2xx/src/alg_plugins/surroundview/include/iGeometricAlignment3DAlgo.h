 ...
 *******************************************************************************
 *
 * \file iGeometricAlignment3DAlgo.h
 *
...
#ifndef _IGEOMETRICALIGNMENT3DALGO_H_
#define _IGEOMETRICALIGNMENT3DALGO_H_
...
typedef struct {
	...
	SV_GAlign3D_TuningParams GAlignTuningParams;
...
} SV_GAlign3D_CreationParamsStruct;
/**
 *******************************************************************************
 *
...
void Alg_GeometricAlignment3DMemQuery(SV_GAlign3D_CreationParamsStruct *GAlign_CreateParams,
 ...
 *******************************************************************************
 */
void *Alg_GeometricAlignment3DCreate(SV_GAlign3D_CreationParamsStruct *pCreateParams,
                                    AlgLink_MemRequests *memPtr);
 ...
 *******************************************************************************
 */
Int32 Alg_GeometricAlignment3DProcess( void			   *algHandle,
 ...
 *******************************************************************************
 */
Int32 Alg_GeometricAlignment3DControl(void			        *algHandle,
									SV_GAlign3D_ControlParams *GAlign_Mode);
 ...
 *******************************************************************************
 */
Int32 Alg_GeometricAlignment3DDelete(void *algHandle,
                                   AlgLink_MemRequests *memPtr);
