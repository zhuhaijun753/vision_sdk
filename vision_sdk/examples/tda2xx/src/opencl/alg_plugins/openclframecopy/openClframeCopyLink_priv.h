 ...
 *******************************************************************************
 *
 * \file openclframeCopyLink_priv.h Frame Copy Algorithm Link private
 *                            API/Data structures
 *
...
#ifndef _OPENCLFRAMECOPY_LINK_PRIV_H_
#define _OPENCLFRAMECOPY_LINK_PRIV_H_
...
typedef  struct
{
    ...
    AlgorithmLink_OpenCLFrameCopyCreateParams algLinkCreateParams;
    /**< Create params of the frame copy algorithm Link*/
    Alg_OpenCLFrameCopyCreateParams   createParams;
    /**< Create params of the frame copy algorithm */
    Alg_OpenCLFrameCopyControlParams  controlParams;
     ...
     */
} AlgorithmLink_OpenCLFrameCopyObj;
