...
/**
 *******************************************************************************
 * \file CannyEdgeLink_algPlugin.c
 *
 ...
 *******************************************************************************
 */
#include "openClCannyEdgeLink_priv.h"
 ...
 *******************************************************************************
 */
Int32 AlgorithmLink_OpenCLCannyEdge_initPlugin()
{
    AlgorithmLink_FuncTable pluginFunctions;
    UInt32 algId = (UInt32)-1;

    pluginFunctions.AlgorithmLink_AlgPluginCreate =
        AlgorithmLink_openclCannyEdgeCreate;
    pluginFunctions.AlgorithmLink_AlgPluginProcess =
        AlgorithmLink_openclCannyEdgeProcess;
    pluginFunctions.AlgorithmLink_AlgPluginControl =
        AlgorithmLink_openclCannyEdgeControl;
    pluginFunctions.AlgorithmLink_AlgPluginStop =
        AlgorithmLink_openclCannyEdgeStop;
    pluginFunctions.AlgorithmLink_AlgPluginDelete =
        AlgorithmLink_openclCannyEdgeDelete;

    algId = ALGORITHM_LINK_A15_ALG_OPENCLCANNYEDGE;
...
Int32 AlgorithmLink_openclCannyEdgeCreate(void * pObj, void * pCreateParams)
{
    ...
    AlgorithmLink_OpenCLCannyEdgeObj          * pOpenCLCannyEdgeObj;
    AlgorithmLink_OpenCLCannyEdgeCreateParams * pOpenCLCannyEdgeCreateParams;
    AlgorithmLink_OutputQueueInfo             * pOutputQInfo;
    AlgorithmLink_InputQueueInfo              * pInputQInfo;


    pOpenCLCannyEdgeCreateParams =
        (AlgorithmLink_OpenCLCannyEdgeCreateParams *)pCreateParams;

    /*
     * Space for Algorithm specific object gets allocated here.
     * Pointer gets recorded in algorithmParams
     */
    pOpenCLCannyEdgeObj = (AlgorithmLink_OpenCLCannyEdgeObj *)
                        Utils_memAlloc(UTILS_HEAPID_DDR_CACHED_LOCAL,
                                       sizeof(AlgorithmLink_OpenCLCannyEdgeObj), 32);

    UTILS_assert(pOpenCLCannyEdgeObj!=NULL);

    pOutputQInfo = &pOpenCLCannyEdgeObj->outputQInfo;
    pInputQInfo  = &pOpenCLCannyEdgeObj->inputQInfo;

    AlgorithmLink_setAlgorithmParamsObj(pObj, pOpenCLCannyEdgeObj);

    /*
     * Taking copy of needed create time parameters in local object for future
     * reference.
     */
    pOpenCLCannyEdgeObj->algLinkCreateParams.maxHeight =
        pOpenCLCannyEdgeCreateParams->maxHeight;
    pOpenCLCannyEdgeObj->algLinkCreateParams.maxWidth  =
        pOpenCLCannyEdgeCreateParams->maxWidth;
    pOpenCLCannyEdgeObj->algLinkCreateParams.numOutputFrames =
        pOpenCLCannyEdgeCreateParams->numOutputFrames;

    memcpy((void*)(&pOpenCLCannyEdgeObj->outQueParams),
           (void*)(&pOpenCLCannyEdgeCreateParams->outQueParams),
           sizeof(System_LinkOutQueParams));
    memcpy((void*)(&pOpenCLCannyEdgeObj->inQueParams),
           (void*)(&pOpenCLCannyEdgeCreateParams->inQueParams),
     ...
     */
    status = System_linkGetInfo(pOpenCLCannyEdgeCreateParams->inQueParams.prevLinkId,
                                &prevLinkInfo);

    prevLinkQueId = pOpenCLCannyEdgeCreateParams->inQueParams.prevLinkQueId;

    pOpenCLCannyEdgeObj->numInputChannels = prevLinkInfo.queInfo[prevLinkQueId].numCh;

    maxHeight = pOpenCLCannyEdgeObj->algLinkCreateParams.maxHeight;
    maxWidth  = pOpenCLCannyEdgeObj->algLinkCreateParams.maxWidth;
     ...
     * individual channels
     */
    pOpenCLCannyEdgeObj->pitch = maxWidth;
    if(maxWidth % ALGORITHMLINK_FRAME_ALIGN)
    {
        pOpenCLCannyEdgeObj->pitch += (ALGORITHMLINK_FRAME_ALIGN -
     ...
     */
    for(channelId =0 ; channelId < pOpenCLCannyEdgeObj->numInputChannels; channelId++)
    {
       ...
       * They are set here.
       */
      pOutChInfo->pitch[0] = pOpenCLCannyEdgeObj->pitch;
      pOutChInfo->pitch[1] = pOpenCLCannyEdgeObj->pitch;
      pOutChInfo->pitch[2] = pOpenCLCannyEdgeObj->pitch;

      if(dataFormat == SYSTEM_DF_YUV422I_YUYV)
      {
        pOutChInfo->pitch[0] = pOpenCLCannyEdgeObj->pitch * 2;
      }
       ...
       * use
       */
      memcpy((void *)&(pOpenCLCannyEdgeObj->inputChInfo[channelId]),
    ...
    pOpenCLCannyEdgeObj->createParams.maxHeight    = maxHeight;
    pOpenCLCannyEdgeObj->createParams.maxWidth     = maxWidth;
    pOpenCLCannyEdgeObj->frameDropCounter          = 0;

    algHandle = Alg_OpenCLCannyEdgeCreate(&pOpenCLCannyEdgeObj->createParams);
    UTILS_assert(algHandle != NULL);

    pOpenCLCannyEdgeObj->algHandle = algHandle;
    ...
    {
      for(frameIdx = 0;
          frameIdx < pOpenCLCannyEdgeObj->algLinkCreateParams.numOutputFrames;
          frameIdx++)
      {
        pSystemBuffer           =
                             &(pOpenCLCannyEdgeObj->buffers[channelId][frameIdx]);
        pSystemVideoFrameBuffer =
                             &(pOpenCLCannyEdgeObj->videoFrames[channelId][frameIdx]);
        ...
        pSystemVideoFrameBuffer->bufAddr[0] = Utils_memAlloc(
                                           ...
                                           (maxHeight*(pOpenCLCannyEdgeObj->pitch)*2),
        ...
        pSystemVideoFrameBuffer->bufAddr[1] = (void*)(
            ...
            (UInt32)(maxHeight*(pOpenCLCannyEdgeObj->pitch))
            );
    ...
    pOpenCLCannyEdgeObj->linkStatsInfo = Utils_linkStatsCollectorAllocInst(
        AlgorithmLink_getLinkId(pObj), "ALG_FRAME_COPY");
    UTILS_assert(NULL != pOpenCLCannyEdgeObj->linkStatsInfo);

    pOpenCLCannyEdgeObj->isFirstFrameRecv = FALSE;
...
Int32 AlgorithmLink_openclCannyEdgeProcess(void * pObj)
{
    ...
    Bool                         bufDropFlag;
    AlgorithmLink_CannyMode       copyMode;
    System_LinkStatistics      * linkStatsInfo;


    pCannyEdgeObj = (AlgorithmLink_OpenCLCannyEdgeObj *)
                        AlgorithmLink_getAlgorithmParamsObj(pObj);

    linkStatsInfo = pCannyEdgeObj->linkStatsInfo;
    UTILS_assert(NULL != linkStatsInfo);

    algHandle     = pCannyEdgeObj->algHandle;
     ...
     */
    System_getLinksFullBuffers(pCannyEdgeObj->inQueParams.prevLinkId,
                               pCannyEdgeObj->inQueParams.prevLinkQueId,
                               &inputBufList);

    if(inputBufList.numBuf)
    {
        if(pCannyEdgeObj->isFirstFrameRecv==FALSE)
        {
            pCannyEdgeObj->isFirstFrameRecv = TRUE;

            Utils_resetLinkStatistics(
                    &linkStatsInfo->linkStats,
                    pCannyEdgeObj->numInputChannels,
                    1);
        ...
        for (bufId = 0; bufId < inputBufList.numBuf; bufId++)
        {
          ...
          if(channelId < pCannyEdgeObj->numInputChannels)
          {
          ...
          if((pSysBufferInput->bufType != SYSTEM_BUFFER_TYPE_VIDEO_FRAME)
             ||
             (channelId >= pCannyEdgeObj->numInputChannels)
            )
          {
            bufDropFlag = TRUE;
          ...
          pOutputChInfo = &(pCannyEdgeObj->outputQInfo.queInfo.chInfo[channelId]);
          pInputChInfo  = &(pCannyEdgeObj->inputChInfo[channelId]);
                        ...
                        pSysVideoFrameBufferInput->chInfo.flags))
          {
            ...
            memcpy(&(pCannyEdgeObj->inputChInfo[channelId]),
                   pInputChInfo,
                   sizeof(System_LinkChInfo));
             ...
             */
            pOutputChInfo->pitch[0] = pCannyEdgeObj->pitch;
            if(dataFormat == SYSTEM_DF_YUV422I_YUYV)
            {
                pOutputChInfo->pitch[0] = pCannyEdgeObj->pitch * 2;
            }
           ...
           * Default
           */
          copyMode = ALGORITHM_LINK_A15_ALG_OPENCL_CANNYEDGE;
           ...
           */
          if(copyMode == ALGORITHM_LINK_A15_ALG_OPENCL_CANNYEDGE)
          {
          ...
          Alg_OpenCLCannyEdgeProcess(algHandle,
           ...
           * processing
           */
          System_sendLinkCmd(pCannyEdgeObj->outQueParams.nextLink,
                             SYSTEM_CMD_NEW_DATA,
                             NULL);
          ...
          AlgorithmLink_releaseInputBuffer(
                                      pObj,
                                      inputQId,
                                      pCannyEdgeObj->inQueParams.prevLinkId,
                                      pCannyEdgeObj->inQueParams.prevLinkQueId,
                                      &inputBufListReturn,
                                      &bufDropFlag);
...
Int32 AlgorithmLink_openclCannyEdgeControl(void * pObj, void * pControlParams)
{
    ...
    switch(pAlgLinkControlPrm->controlCmd)
    {
        ...
        case SYSTEM_CMD_PRINT_STATISTICS:
            AlgorithmLink_openclCannyEdgePrintStatistics(pObj, pCannyEdgeObj);
            break;

        default:
            status = Alg_OpenCLCannyEdgeControl(algHandle,
                                          &(pCannyEdgeObj->controlParams)
                                          );
            break;
    }
...
Int32 AlgorithmLink_openclCannyEdgeDelete(void * pObj)
{
    ...
    status = Utils_linkStatsCollectorDeAllocInst(pCannyEdgeObj->linkStatsInfo);
    UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);

    status = Alg_OpenCLCannyEdgeDelete(algHandle);
    UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);

    maxHeight = pCannyEdgeObj->algLinkCreateParams.maxHeight;

    for(channelId =0 ; channelId < pCannyEdgeObj->numInputChannels; channelId++)
    {
      for(frameIdx = 0;
          frameIdx < (pCannyEdgeObj->algLinkCreateParams.numOutputFrames);
          frameIdx++)
      {
        pSystemVideoFrameBuffer =
                             &(pCannyEdgeObj->videoFrames[channelId][frameIdx]);
        ...
        status = Utils_memFree(UTILS_HEAPID_DDR_CACHED_SR_ECC_ASIL,
                               ...
                               (maxHeight*pCannyEdgeObj->pitch*2)
                               );
        UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);
      }
    }
    ...
    status = Utils_memFree(UTILS_HEAPID_DDR_CACHED_LOCAL,
                           pCannyEdgeObj, sizeof(AlgorithmLink_OpenCLCannyEdgeObj));
    UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);
 ...
 *
 * \param  pObj                [IN] Algorithm link object handle
 * \param  pCannyEdgeObj       [IN] Frame copy link Object handle
 *
 * \return  SYSTEM_LINK_STATUS_SOK on success
 *
 *******************************************************************************
                       ...
                       AlgorithmLink_OpenCLCannyEdgeObj *pCannyEdgeObj)
{
    ...
    UTILS_assert(NULL != pCannyEdgeObj->linkStatsInfo);

    Utils_printLinkStatistics(&pCannyEdgeObj->linkStatsInfo->linkStats, "ALG_CannyEdge", TRUE);

    Utils_printLatency("ALG_CannyEdge",
                       &pCannyEdgeObj->linkStatsInfo->linkLatency,
                       &pCannyEdgeObj->linkStatsInfo->srcToLinkLatency,
                        TRUE
                       );
