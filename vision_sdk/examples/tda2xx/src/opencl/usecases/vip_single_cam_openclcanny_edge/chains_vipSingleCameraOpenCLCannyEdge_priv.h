...
#ifndef _chains_vipSingleCameraOpenCLCannyEdge_H_
#define _chains_vipSingleCameraOpenCLCannyEdge_H_
...
typedef struct {
       ...
       UInt32    Alg_OpenCLCannyEdgeLinkID;
       ...
       AlgorithmLink_OpenCLCannyEdgeCreateParams  Alg_OpenCLCannyEdgePrm;
...
} chains_vipSingleCameraOpenCLCannyEdgeObj;
...
Void chains_vipSingleCameraOpenCLCannyEdge_SetAppPrms(chains_vipSingleCameraOpenCLCannyEdgeObj *pObj, Void *appObj);

#endif /* _chains_vipSingleCameraOpenCLCannyEdge_H_ */
