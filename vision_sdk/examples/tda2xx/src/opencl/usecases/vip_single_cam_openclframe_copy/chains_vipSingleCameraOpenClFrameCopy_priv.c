...
Void chains_vipSingleCameraOpenCLFrameCopy_SetLinkId(chains_vipSingleCameraOpenCLFrameCopyObj *pObj){
       ...
       pObj->Alg_OpenCLFrameCopyLinkID      = A15_0_LINK (SYSTEM_LINK_ID_ALG_0);
...
Void chains_vipSingleCameraOpenCLFrameCopy_ResetLinkPrms(chains_vipSingleCameraOpenCLFrameCopyObj *pObj){
       ...
       AlgorithmLink_OpenCLFrameCopy_Init(&pObj->Alg_OpenCLFrameCopyPrm);
...
Void chains_vipSingleCameraOpenCLFrameCopy_ConnectLinks(chains_vipSingleCameraOpenCLFrameCopyObj *pObj){
       ...
       //IPCIn_A15_0_IPU1_0_0 -> Alg_OpenCLFrameCopy
       pObj->IPCIn_A15_0_IPU1_0_0Prm.outQueParams.nextLink = pObj->Alg_OpenCLFrameCopyLinkID;
       pObj->Alg_OpenCLFrameCopyPrm.inQueParams.prevLinkId = pObj->IPCIn_A15_0_IPU1_0_0LinkID;
       pObj->Alg_OpenCLFrameCopyPrm.inQueParams.prevLinkQueId = 0;

       //Alg_OpenCLFrameCopy -> IPCOut_A15_0_IPU1_0_0
       pObj->Alg_OpenCLFrameCopyPrm.outQueParams.nextLink = pObj->IPCOut_A15_0_IPU1_0_0LinkID;
       pObj->IPCOut_A15_0_IPU1_0_0Prm.inQueParams.prevLinkId = pObj->Alg_OpenCLFrameCopyLinkID;
...
Int32 chains_vipSingleCameraOpenCLFrameCopy_Create(chains_vipSingleCameraOpenCLFrameCopyObj *pObj, Void *appObj){
       ...
       chains_vipSingleCameraOpenCLFrameCopy_SetLinkId(pObj);
       chains_vipSingleCameraOpenCLFrameCopy_ResetLinkPrms(pObj);

       chains_vipSingleCameraOpenCLFrameCopy_SetPrms(pObj);
       chains_vipSingleCameraOpenCLFrameCopy_SetAppPrms(pObj, appObj);

       chains_vipSingleCameraOpenCLFrameCopy_ConnectLinks(pObj);
       ...
       status = System_linkCreate(pObj->Alg_OpenCLFrameCopyLinkID, &pObj->Alg_OpenCLFrameCopyPrm, sizeof(pObj->Alg_OpenCLFrameCopyPrm));
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);
...
Int32 chains_vipSingleCameraOpenCLFrameCopy_Start(chains_vipSingleCameraOpenCLFrameCopyObj *pObj){
       ...
       status = System_linkStart(pObj->Alg_OpenCLFrameCopyLinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);
...
Int32 chains_vipSingleCameraOpenCLFrameCopy_Stop(chains_vipSingleCameraOpenCLFrameCopyObj *pObj){
       ...
       status = System_linkStop(pObj->Alg_OpenCLFrameCopyLinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);
...
Int32 chains_vipSingleCameraOpenCLFrameCopy_Delete(chains_vipSingleCameraOpenCLFrameCopyObj *pObj){
       ...
       status = System_linkDelete(pObj->Alg_OpenCLFrameCopyLinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);
...
Void chains_vipSingleCameraOpenCLFrameCopy_printBufferStatistics(chains_vipSingleCameraOpenCLFrameCopyObj *pObj){
       ...
       System_linkPrintBufferStatistics(pObj->Alg_OpenCLFrameCopyLinkID);
...
Void chains_vipSingleCameraOpenCLFrameCopy_printStatistics(chains_vipSingleCameraOpenCLFrameCopyObj *pObj){
       ...
       System_linkPrintStatistics(pObj->Alg_OpenCLFrameCopyLinkID);
