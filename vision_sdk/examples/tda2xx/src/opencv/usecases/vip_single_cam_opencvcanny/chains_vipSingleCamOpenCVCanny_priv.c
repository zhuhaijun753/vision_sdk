...
Void chains_vipSingleCamOpenCVCanny_ResetLinkPrms(chains_vipSingleCamOpenCVCannyObj *pObj){
       ...
       AlgorithmLink_OpenCVCanny_Init(&pObj->Alg_OpenCVCannyPrm);
...
Void chains_vipSingleCamOpenCVCanny_ConnectLinks(chains_vipSingleCamOpenCVCannyObj *pObj){
       ...
       //Alg_OpenCVCanny -> IPCOut_A15_0_IPU1_0_0
       pObj->Alg_OpenCVCannyPrm.outQueParams.nextLink = pObj->IPCOut_A15_0_IPU1_0_0LinkID;
       pObj->IPCOut_A15_0_IPU1_0_0Prm.inQueParams.prevLinkId = pObj->Alg_OpenCVCannyLinkID;
...
Int32 chains_vipSingleCamOpenCVCanny_Create(chains_vipSingleCamOpenCVCannyObj *pObj, Void *appObj){
       ...
       chains_vipSingleCamOpenCVCanny_SetLinkId(pObj);
       chains_vipSingleCamOpenCVCanny_ResetLinkPrms(pObj);

       chains_vipSingleCamOpenCVCanny_SetPrms(pObj);
       chains_vipSingleCamOpenCVCanny_SetAppPrms(pObj, appObj);

       chains_vipSingleCamOpenCVCanny_ConnectLinks(pObj);
