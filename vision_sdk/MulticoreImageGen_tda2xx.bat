...
set App_MPU_CPU0=%CD%\binaries\vision_sdk\bin\tda2xx-evm\vision_sdk_a15_0_$profile.xa15fg
set App_MPU_CPU1=
REM App_MPU_SMP is to define MPU SMP application, To enable SMP mode - remove "App_MPU_CPU0" & set "APP_MPU_SMP"
REM set APP_MPU_SMP=%CD%\binaries\vision_sdk\bin\tda2xx-evm\vision_sdk_a15_0_$profile.xa15fg
...
REM set App_IPU2_CPU0=%CD%\binaries\vision_sdk\bin\tda2xx-evm\vision_sdk_ipu2_%profile%.xem4
REM set App_IPU2_CPU1=
REM App_IPU2_CPU_SMP is to define the IPU SMP application
REM set App_IPU2_CPU_SMP=%CD%\binaries\vision_sdk\bin\tda2xx-evm\vision_sdk_ipu2_%profile%.xem4
...
REM set App_EVE3=%CD%\binaries\vision_sdk\bin\tda2xx-evm\vision_sdk_arp32_3_%profile%.xearp32F
REM set App_EVE4=%CD%\binaries\vision_sdk\bin\tda2xx-evm\vision_sdk_arp32_4_%profile%.xearp32F
