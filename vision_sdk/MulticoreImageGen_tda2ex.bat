REM @echo off
REM Define Device Id TDA2Ex - 66 - choosen random value will be updated
...
set Out_Path=%CD%\binaries\vision_sdk\bin\tda2ex-evm\sbl_boot
...
set App_MPU_CPU0=%CD%\binaries\vision_sdk\bin\tda2ex-evm\vision_sdk_a15_0_$profile.xa15fg
set App_MPU_CPU1=
set App_IPU1_CPU0=%CD%\binaries\vision_sdk\bin\tda2ex-evm\vision_sdk_ipu1_0_%profile%.xem4
set App_IPU1_CPU1=%CD%\binaries\vision_sdk\bin\tda2ex-evm\vision_sdk_ipu1_1_%profile%.xem4
REM App_IPU1_CPU_SMP is to define the IPU SMP application
set App_IPU1_CPU_SMP=
REM set App_IPU2_CPU0=%CD%\binaries\vision_sdk\bin\tda2ex-evm\vision_sdk_ipu2_%profile%.xem4
REM set App_IPU2_CPU1=
REM App_IPU2_CPU_SMP is to define the IPU SMP application
REM set App_IPU2_CPU_SMP=%CD%\binaries\vision_sdk\bin\tda2ex-evm\vision_sdk_ipu2_%profile%.xem4
set App_DSP1=%CD%\binaries\vision_sdk\bin\tda2ex-evm\vision_sdk_c66xdsp_1_%profile%.xe66
