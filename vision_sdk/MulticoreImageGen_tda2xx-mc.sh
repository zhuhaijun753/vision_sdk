...
export Out_Path=$PWD/binaries/vision_sdk/bin/tda2xx-mc/sbl_boot
...
export App_MPU_CPU0=$PWD/binaries/vision_sdk/bin/tda2xx-mc/vision_sdk_a15_0_$profile.xa15fg
export App_MPU_CPU1=
# App_MPU_SMP is to define MPU SMP application, To enable SMP mode - remove "App_MPU_CPU0" & set "APP_MPU_SMP"
# export APP_MPU_SMP=$PWD/binaries/vision_sdk/bin/tda2xx-mc/vision_sdk_a15_0_$profile.xa15fg
export App_IPU1_CPU0=$PWD/binaries/vision_sdk/bin/tda2xx-mc/vision_sdk_ipu1_0_$profile.xem4
export App_IPU1_CPU1=$PWD/binaries/vision_sdk/bin/tda2xx-mc/vision_sdk_ipu1_1_$profile.xem4
# App_IPU1_CPU_SMP is to define the IPU SMP application
export App_IPU1_CPU_SMP=
# export App_IPU2_CPU0=$PWD/binaries/vision_sdk/bin/tda2xx-mc/vision_sdk_ipu2_$profile.xem4
# export App_IPU2_CPU1=
# App_IPU2_CPU_SMP is to define the IPU SMP application
# export App_IPU2_CPU_SMP=$PWD/binaries/vision_sdk/bin/tda2xx-mc/vision_sdk_ipu2_$profile.xem4
export App_DSP1=$PWD/binaries/vision_sdk/bin/tda2xx-mc/vision_sdk_c66xdsp_1_$profile.xe66
export App_DSP2=$PWD/binaries/vision_sdk/bin/tda2xx-mc/vision_sdk_c66xdsp_2_$profile.xe66
export App_EVE1=$PWD/binaries/vision_sdk/bin/tda2xx-mc/vision_sdk_arp32_1_$profile.xearp32F
export App_EVE2=$PWD/binaries/vision_sdk/bin/tda2xx-mc/vision_sdk_arp32_2_$profile.xearp32F
export App_EVE3=$PWD/binaries/vision_sdk/bin/tda2xx-mc/vision_sdk_arp32_3_$profile.xearp32F
export App_EVE4=$PWD/binaries/vision_sdk/bin/tda2xx-mc/vision_sdk_arp32_4_$profile.xearp32F
...
echo ""
echo "!!!!!Ensure SBL was built before running this script using \"make -s sbl_sd sbl_qspi VSDK_BOARD_TYPE=TDA2XX_MC\" !!!!!"
echo ""
echo "Generating SBL images..."
./create-boot-image.sh MLO ../../vision_sdk/build/scripts/mlo_tda2xx-mc_hs/unsigned_MLO  ../../vision_sdk/build/scripts/mlo_tda2xx-mc_hs/MLO > /dev/null
errorCheck $?
./create-boot-image.sh X-LOADER ../../vision_sdk/build/scripts/qspi_tda2xx-mc_hs/unsigned_sbl_qspi_LE  ../../vision_sdk/build/scripts/qspi_tda2xx-mc_hs/XLOADER > /dev/null
errorCheck $?
#Convert to BE as required by qspiflashwriter
xxd -p -c 4  ../../vision_sdk/build/scripts/qspi_tda2xx-mc_hs/XLOADER  | sed "s/\(..\)\(..\)\(..\)\(..\)/\4\3\2\1/" | xxd -r -p >  ../../vision_sdk/build/scripts/qspi_tda2xx-mc_hs/XLOADER_BE
errorCheck $?
