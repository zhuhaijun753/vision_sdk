 ...
 *******************************************************************************
 *
 * \file utils_dma_cfg_ipu2.c
 *
 * \brief This file has the configuration for IPU2 CPU
 *
...
#define UTILS_IPU2_XBAR_OFFSET                  (23U-1U)

/** Interrupt no. for Transfer Completion */
#define UTILS_DMA_SYS_EDMA_CCXFER_COMPLETION_INT  (25U)
...
#define UTILS_DMA_SYSTEM_DMA_BASE_ADDR            (0x63300000U)
...
EDMA3_DRV_InstanceInitConfig gUtils_dmaSysEdmaInstInitConfig =
{
    ...
    {UTILS_IPU2_EDMACH_ALLOC_0, UTILS_IPU2_EDMACH_ALLOC_1, UTILS_IPU2_PARAM_ALLOC_0, UTILS_IPU2_PARAM_ALLOC_1,
    /* 159  128                     191  160                    223  192                    255  224 */
     UTILS_IPU2_PARAM_ALLOC_2 , UTILS_IPU2_PARAM_ALLOC_3 , UTILS_IPU2_PARAM_ALLOC_4, UTILS_IPU2_PARAM_ALLOC_5,
    /* 287  256                     319  288                    351  320                    383  352 */
     UTILS_IPU2_PARAM_ALLOC_6 , UTILS_IPU2_PARAM_ALLOC_7 , UTILS_IPU2_PARAM_ALLOC_8, UTILS_IPU2_PARAM_ALLOC_9,
    /* 415  384                     447  416                    479  448                    511  480 */
     UTILS_IPU2_PARAM_ALLOC_10, UTILS_IPU2_PARAM_ALLOC_11, UTILS_IPU2_PARAM_ALLOC_12, UTILS_IPU2_PARAM_ALLOC_13},

    /* ownDmaChannels */
    /* 31     0                     63    32 */
    {UTILS_IPU2_EDMACH_ALLOC_0, UTILS_IPU2_EDMACH_ALLOC_1},
...
UInt32 Utils_edma3GetRegionId(UInt32 edmaInstId)
{
    ...
    return UTILS_DMA_SYSTEM_DMA_IPU2_REGION;
}
...
Utils_DmaIntrCfg *Utils_edma3GetIntrCfg (UInt32 edmaInstId)
{
    ...
    gUtils_dmaSysEdmaIntrCfg.ccXferCompCtrlModXbarIndex
        = UTILS_DMA_SYS_EDMA_CCXFER_COMPLETION_INT - UTILS_IPU2_XBAR_OFFSET;
    ...
    gUtils_dmaSysEdmaIntrCfg.ccErrorCtrlModXbarIndex
        = UTILS_DMA_SYS_EDMA_CCERROR_INT - UTILS_IPU2_XBAR_OFFSET;
    ...
    gUtils_dmaSysEdmaIntrCfg.tc0ErrorCtrlModXbarIndex
        = UTILS_DMA_SYS_EDMA_TC0_ERROR_INT - UTILS_IPU2_XBAR_OFFSET;
