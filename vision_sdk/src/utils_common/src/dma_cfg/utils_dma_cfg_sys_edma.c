...
#define UTILS_DMA_SYSTEM_DMA_IPU2_REGION        (5U)

#ifndef A15_TARGET_OS_LINUX
/*******************************************************************************
 *  IPU1_0 and IPU2 EDMA channel allocation
 *******************************************************************************
 */
...
#define UTILS_IPU2_EDMACH_ALLOC_0     (0x000F0000U)
#define UTILS_IPU2_EDMACH_ALLOC_1     (0x00000000U)
#endif

#ifdef IPU_PRIMARY_CORE_IPU2
#define UTILS_IPU1_0_EDMACH_ALLOC_0     (0x000F0000U)
#define UTILS_IPU1_0_EDMACH_ALLOC_1     (0x00000000U)

#define UTILS_IPU2_EDMACH_ALLOC_0     (0x00000000U)
#define UTILS_IPU2_EDMACH_ALLOC_1     (0xFFFF0000U)
#endif
/*******************************************************************************
...
/*******************************************************************************
 *  IPU1_0 and IPU2 EDMA allocation
 *******************************************************************************
 */
#ifdef IPU_PRIMARY_CORE_IPU1
#define UTILS_IPU1_0_EDMACH_ALLOC_0     (0x00000000U)
...
#define UTILS_IPU2_EDMACH_ALLOC_0     (0x00000000U)
#define UTILS_IPU2_EDMACH_ALLOC_1     (0x000F0000U)
#endif

#ifdef IPU_PRIMARY_CORE_IPU2
#define UTILS_IPU1_0_EDMACH_ALLOC_0     (0x00000000U)
#define UTILS_IPU1_0_EDMACH_ALLOC_1     (0x000F0000U)

#define UTILS_IPU2_EDMACH_ALLOC_0     (0x00000000U)
#define UTILS_IPU2_EDMACH_ALLOC_1     (0x0000FFFFU)
#endif
...
#define UTILS_IPU1_1_EDMACH_ALLOC_1     (0x00F00000U)
...
#endif
#ifdef IPU_PRIMARY_CORE_IPU2
#define UTILS_IPU1_0_PARAM_ALLOC_0      (0x00000000U)
#define UTILS_IPU1_0_PARAM_ALLOC_1      (0x00000000U)
#define UTILS_IPU1_0_PARAM_ALLOC_2      (0x000000FFU)
#endif
...
/*******************************************************************************
 *  IPU2 EDMA allocation
 *******************************************************************************
 */
#ifdef NDK_PROC_TO_USE_IPU2
#define UTILS_IPU2_QDMACH_ALLOC_0     (0x0000000FU) /* required for AVB */
#else
#define UTILS_IPU2_QDMACH_ALLOC_0     (0x00000000U)
#endif
#ifdef IPU_PRIMARY_CORE_IPU1
#define UTILS_IPU2_PARAM_ALLOC_0      (0x00000000U)
#define UTILS_IPU2_PARAM_ALLOC_1      (0x00000000U)
#define UTILS_IPU2_PARAM_ALLOC_2      (0x000000FFU)
#endif
#ifdef IPU_PRIMARY_CORE_IPU2
#define UTILS_IPU2_PARAM_ALLOC_0      (0xFFFFFFFFU)
#define UTILS_IPU2_PARAM_ALLOC_1      (0xFFFFFFFFU)
#define UTILS_IPU2_PARAM_ALLOC_2      (0x00000000U)
#endif
#define UTILS_IPU2_PARAM_ALLOC_3      (0x00000000U)
#define UTILS_IPU2_PARAM_ALLOC_4      (0x00000000U)
#define UTILS_IPU2_PARAM_ALLOC_5      (0x00000000U)
#define UTILS_IPU2_PARAM_ALLOC_6      (0x00000000U)
#define UTILS_IPU2_PARAM_ALLOC_7      (0x00000000U)
#define UTILS_IPU2_PARAM_ALLOC_8      (0x00000000U)
#define UTILS_IPU2_PARAM_ALLOC_9      (0x00000000U)
#ifdef NDK_PROC_TO_USE_IPU2
#define UTILS_IPU2_PARAM_ALLOC_10     (0xFFFFFFFFU) /* required for AVB */
#define UTILS_IPU2_PARAM_ALLOC_11     (0xFFFFFFFFU) /* required for AVB */
#define UTILS_IPU2_PARAM_ALLOC_12     (0xFFFFFFFFU) /* required for AVB */
#define UTILS_IPU2_PARAM_ALLOC_13     (0xFFFFFFFFU) /* required for AVB */
#else
#define UTILS_IPU2_PARAM_ALLOC_10     (0x00000000U)
#define UTILS_IPU2_PARAM_ALLOC_11     (0x00000000U)
#define UTILS_IPU2_PARAM_ALLOC_12     (0x00000000U)
#define UTILS_IPU2_PARAM_ALLOC_13     (0x00000000U)
#endif
 ...
 * \param maskIpu2      [IN] Allocation mask
 *
 *******************************************************************************
 */
                        ...
                        )
{
    ...
    mask[numMask] = maskIpu1_0 & maskIpu2;
    numMask++;
    UTILS_assert(numMask <= UTILS_ARRAYSIZE(mask));
    ...
    mask[numMask] = maskIpu1_1 & maskIpu2;
    numMask++;
    UTILS_assert(numMask <= UTILS_ARRAYSIZE(mask));
    ...
    mask[numMask] = maskDsp1 & maskIpu2;
    numMask++;
    UTILS_assert(numMask <= UTILS_ARRAYSIZE(mask));
    ...
    mask[numMask] = maskDsp2 & maskIpu2;
    numMask++;
    UTILS_assert(numMask <= UTILS_ARRAYSIZE(mask));


    mask[numMask] = maskA15_0   & maskIpu2;
    numMask++;
    UTILS_assert(numMask <= UTILS_ARRAYSIZE(mask));
