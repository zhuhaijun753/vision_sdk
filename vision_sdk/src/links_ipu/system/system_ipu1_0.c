...
#include <src/utils_common/include/utils_esm.h>
#endif
 ...
 *******************************************************************************
 */
void Utils_tda2x3dSrvAcInit(void);
void Utils_tda2x3dSrvAcDeInit(void);
/**
 *******************************************************************************
...
Int32 System_init(void)
{
   ...
   /* TDA2X 3D SRV Auto Calibration Init */
   Utils_tda2x3dSrvAcInit();
#endif
...
#ifdef ALG_SV_INCLUDE
   /* TDA2X 3D SRV Auto Calibration DeInit */
   Utils_tda2x3dSrvAcDeInit();
#endif
