...
Int32 VpeLink_drvCreateIspPrms(VpeLink_Obj * pObj, UInt32 chId)
{
    ...
    pChObj->drvIspPrms.enableStreams[VPS_ISS_STREAM_CAL_RD_INPUT_0] = (UInt32)TRUE;
...
Int32 VpeLink_drvCreateRszCfgPrms(VpeLink_Obj * pObj, UInt32 chId)
{
    ...
    pChObj->drvRszCfg.instCfg[0U].overrideScaleFactor = FALSE;

    pChObj->drvRszCfg.instCfg[1U].enable = FALSE;
    pChObj->drvRszCfg.instCfg[1U].overrideScaleFactor = FALSE;
