 ...
 * \defgroup IPC_OUT_LINK_IMPL IPC Link Implementation
 *
 * @{
 */
 ...
 *******************************************************************************
 *
 * \file ipcOutLink_cfg.h Algorithm Link private API/Data structures
 *
...
#ifndef IPC_OUT_LINK_CFG_H_
#define IPC_OUT_LINK_CFG_H_
...
#ifdef BUILD_DSP_1
#define IPC_OUT_LINK_OBJ_MAX        (10U)
#define IPC_OUT_LINK_TSK_STACK_SIZE (SYSTEM_DEFAULT_TSK_STACK_SIZE)
#endif
...
#ifdef BUILD_ARP32_1
#define IPC_OUT_LINK_OBJ_MAX        (10U)
#define IPC_OUT_LINK_TSK_STACK_SIZE (2*KB)
#endif
