...
Void System_waitAppInitComplete(void)
{
    ...
    initDone[SYSTEM_IPU_PROC_PRIMARY] = (UInt32)TRUE;
...
{
    UInt32 state = CORE_APP_INITSTATUS_PRE_INIT;
...
{
    UInt32 procId;
    UInt32 state = CORE_APP_INITSTATUS_DO_INIT;
...
{
    Int32 freeIdx = -1, status = SYSTEM_LINK_STATUS_EFAIL;
    UInt32 i;
