...
sgx_install:
	...
	cp $(pvr_PATH)/Tools/OGLES2/Build/Linux_armv7/ReleaseNullWS/libogles2tools.a $(LINUX_TARGETFS)/usr/lib
	mkdir -p $(LINUX_TARGETFS)/opt/vision_sdk
	cp $(vision_sdk_PATH)/linux/scripts/pvrscope $(LINUX_TARGETFS)/opt/vision_sdk
