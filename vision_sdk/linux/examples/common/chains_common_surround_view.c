...
#define SV_OUTPUT_WIDTH                 (1080) //(720)
                  ...
                  UInt8 svOutputMode)
{
    ...
    gaCalibPrm->svOutputMode = svOutputMode;
                  ...
                  UInt8 svOutputMode)
{
    ...
    gaCalibPrm->userGaSgxLut = userGaSgxLut;
    gaCalibPrm->svOutputMode = svOutputMode;
                                    ...
                                    Bool enableCarOverlayInAlg)
{
    ...
    pPrm->synthLUTSize = svOutHeight*svOutWidth*4;
    pPrm->synthLUTPtr = (UInt8 *)System_ipcMemAlloc(
                            ...
                            Chain_Common_SRV_CalibParams *gaCalibPrm)
{
    ...
    OSA_assert(gaCalibPrm->autoPersMatAddr != 0);
                            ...
                            Chain_Common_SRV_CalibParams *gaCalibPrm)
{
    ...
    pPrm->maxOutputWidth = SV_OUTPUT_WIDTH;
    pPrm->maxOutputHeight = SV_OUTPUT_HEIGHT;
    ...
    pPrm->calParams.autoPersMatDDRPtr =
          (void *)(gaCalibPrm->autoPersMatAddr + GA_MAGIC_PATTERN_SIZE_IN_BYTES);
}
                            ...
                            Chain_Common_SRV_CalibParams *gaCalibPrm)
{
    ...
    OSA_assert(gaCalibPrm->featurePtsAddr != 0);
    pPrm->acDetectParams.acDetectMode = ALGLINK_ACDETECT_MODE_ENABLE;

    pPrm->acDetectParams.featurePtDDRPtr =
          (void *)(gaCalibPrm->featurePtsAddr + GA_MAGIC_PATTERN_SIZE_IN_BYTES);
...
)
{
    ...
    UTILS_assert(pGAlignPrm!=NULL || pGAlign3DPrm!=NULL);
    ...
    else if (pGAlign3DPrm != NULL)
    {
          ChainsCommon_SurroundView_SetGAlign3DParams(pGAlign3DPrm,
                                            svOutputMode,
                                            gaCalibPrm);
    }
