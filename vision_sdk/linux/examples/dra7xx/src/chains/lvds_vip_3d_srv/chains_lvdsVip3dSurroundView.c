            ...
            chains_lvdsVip3dSurroundViewObj *pUcObj, Void *appObj)
{
    ...
    ChainsCommon_SurroundView_SetGAlign3DParams(&pUcObj->Alg_GeoAlign3DPrm,
                                              pObj->svOutputMode,
                                              &pObj->gaCalibPrm);
...
Void chains_lvdsVip3dSurroundView_InitApp()
{
    ...
    userGaSgxLut = FALSE;
    ChainsCommon_SurroundView_InitCalibration(gaCalibPrm, startWithCalibration, userGaSgxLut, pObj->svOutputMode);
...
Int32 chains_lvdsVip3dSurroundView_DeleteApp()
{
    ...
    ChainsCommon_SurroundView_StopCalibration(gaCalibPrm, ALGORITHM_LINK_SRV_OUTPUT_3D);
...
{
    ChainsCommon_SurroundView_MenuCalibration(&gLvdsVip3dSurroundViewObj.gaCalibPrm, ALGORITHM_LINK_SRV_OUTPUT_3D);
}
