...
Void chains_vipSingleCamFrameCopySgxDisplay_ConnectLinks(chains_vipSingleCamFrameCopySgxDisplayObj *pObj){
       ...
       //Alg_FrameCopy -> SgxFrmcpy
       pObj->Alg_FrameCopyPrm.outQueParams.nextLink = pObj->SgxFrmcpyLinkID;
       pObj->SgxFrmcpyPrm.inQueParams.prevLinkId = pObj->Alg_FrameCopyLinkID;
...
Int32 chains_vipSingleCamFrameCopySgxDisplay_Create(chains_vipSingleCamFrameCopySgxDisplayObj *pObj, Void *appObj){
       ...
       chains_vipSingleCamFrameCopySgxDisplay_SetLinkId(pObj);
       chains_vipSingleCamFrameCopySgxDisplay_ResetLinkPrms(pObj);

       chains_vipSingleCamFrameCopySgxDisplay_SetPrms(pObj);
       chains_vipSingleCamFrameCopySgxDisplay_SetAppPrms(pObj, appObj);

       chains_vipSingleCamFrameCopySgxDisplay_ConnectLinks(pObj);
