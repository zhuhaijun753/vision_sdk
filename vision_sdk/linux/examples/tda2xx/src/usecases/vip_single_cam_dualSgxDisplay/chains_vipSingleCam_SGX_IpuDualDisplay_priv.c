...
Void chains_vipSingleCam_SGX_IpuDualDisplay_SetLinkId(chains_vipSingleCam_SGX_IpuDualDisplayObj *pObj){
       ...
       pObj->Display_M4_FPDLinkID           = SYSTEM_LINK_ID_DISPLAY_1;
...
Void chains_vipSingleCam_SGX_IpuDualDisplay_ResetLinkPrms(chains_vipSingleCam_SGX_IpuDualDisplayObj *pObj){
       ...
       DisplayLink_CreateParams_Init(&pObj->Display_M4_FPDPrm);
...
Void chains_vipSingleCam_SGX_IpuDualDisplay_ConnectLinks(chains_vipSingleCam_SGX_IpuDualDisplayObj *pObj){
       ...
       //Dup_Capture -> IPCOut_IPU1_0_A15_0_0
       pObj->Dup_CapturePrm.outQueParams[0].nextLink = pObj->IPCOut_IPU1_0_A15_0_0LinkID;
       pObj->IPCOut_IPU1_0_A15_0_0Prm.inQueParams.prevLinkId = pObj->Dup_CaptureLinkID;
       pObj->IPCOut_IPU1_0_A15_0_0Prm.inQueParams.prevLinkQueId = 0;

       //Dup_Capture -> Display_M4_FPD
       pObj->Dup_CapturePrm.outQueParams[1].nextLink = pObj->Display_M4_FPDLinkID;
       pObj->Display_M4_FPDPrm.inQueParams.prevLinkId = pObj->Dup_CaptureLinkID;
       pObj->Display_M4_FPDPrm.inQueParams.prevLinkQueId = 1;
...
Int32 chains_vipSingleCam_SGX_IpuDualDisplay_Create(chains_vipSingleCam_SGX_IpuDualDisplayObj *pObj, Void *appObj){
       ...
       chains_vipSingleCam_SGX_IpuDualDisplay_SetLinkId(pObj);
       chains_vipSingleCam_SGX_IpuDualDisplay_ResetLinkPrms(pObj);

       chains_vipSingleCam_SGX_IpuDualDisplay_SetPrms(pObj);
       chains_vipSingleCam_SGX_IpuDualDisplay_SetAppPrms(pObj, appObj);

       chains_vipSingleCam_SGX_IpuDualDisplay_ConnectLinks(pObj);
       ...
       status = System_linkCreate(pObj->Display_M4_FPDLinkID, &pObj->Display_M4_FPDPrm, sizeof(pObj->Display_M4_FPDPrm));
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);
...
Int32 chains_vipSingleCam_SGX_IpuDualDisplay_Start(chains_vipSingleCam_SGX_IpuDualDisplayObj *pObj){
       ...
       status = System_linkStart(pObj->Display_M4_FPDLinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);
...
Int32 chains_vipSingleCam_SGX_IpuDualDisplay_Stop(chains_vipSingleCam_SGX_IpuDualDisplayObj *pObj){
       ...
       status = System_linkStop(pObj->Display_M4_FPDLinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);
...
Int32 chains_vipSingleCam_SGX_IpuDualDisplay_Delete(chains_vipSingleCam_SGX_IpuDualDisplayObj *pObj){
       ...
       status = System_linkDelete(pObj->Display_M4_FPDLinkID);
       UTILS_assert(status == SYSTEM_LINK_STATUS_SOK);
...
Void chains_vipSingleCam_SGX_IpuDualDisplay_printBufferStatistics(chains_vipSingleCam_SGX_IpuDualDisplayObj *pObj){
       ...
       System_linkPrintBufferStatistics(pObj->Display_M4_FPDLinkID);
...
Void chains_vipSingleCam_SGX_IpuDualDisplay_printStatistics(chains_vipSingleCam_SGX_IpuDualDisplayObj *pObj){
       ...
       System_linkPrintStatistics(pObj->Display_M4_FPDLinkID);
