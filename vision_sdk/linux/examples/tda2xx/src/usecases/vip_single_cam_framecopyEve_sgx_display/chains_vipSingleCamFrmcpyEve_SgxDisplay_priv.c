...
Int32 chains_vipSingleCamFrmcpyEve_SgxDisplay_Create(chains_vipSingleCamFrmcpyEve_SgxDisplayObj *pObj, Void *appObj){
       ...
       chains_vipSingleCamFrmcpyEve_SgxDisplay_SetLinkId(pObj);
       chains_vipSingleCamFrmcpyEve_SgxDisplay_ResetLinkPrms(pObj);

       chains_vipSingleCamFrmcpyEve_SgxDisplay_SetPrms(pObj);
       chains_vipSingleCamFrmcpyEve_SgxDisplay_SetAppPrms(pObj, appObj);

       chains_vipSingleCamFrmcpyEve_SgxDisplay_ConnectLinks(pObj);
