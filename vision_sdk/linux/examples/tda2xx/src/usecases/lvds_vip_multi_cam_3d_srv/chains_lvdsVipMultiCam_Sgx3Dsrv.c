...
/**
 *******************************************************************************
 * \file chains_lvdsVipMultiCam_Sgx3Dsrv.c
 *
...
Void chains_lvdsVipMultiCam_Sgx3Dsrv(Chains_Ctrl *chainsCfg)
{
    ...
    do
    {
        ...
        /*
         *  Use the user generated GA SGX LUT.
         *  This LUT is generated by running the auto calibration.
         */
        userGaSgxLut = TRUE;
        ChainsCommon_SurroundView_InitCalibration(
                                            gaCalibPrm,
        ...
        if(ALGLINK_GALIGN3D_CALMODE_FORCE_USERGASGXLUT != \
          (AlgorithmLink_GAlign3DCalibrationMode)Chain_Common_SRV_getCalMode())
        {
            Vps_printf(" CHAINS: -------------------------------------------------------------------- \n");
