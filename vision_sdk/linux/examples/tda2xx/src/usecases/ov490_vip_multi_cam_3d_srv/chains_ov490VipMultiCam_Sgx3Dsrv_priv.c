...
Void chains_ov490VipMultiCam_Sgx3Dsrv_SetLinkId(chains_ov490VipMultiCam_Sgx3DsrvObj *pObj){
...
Void chains_ov490VipMultiCam_Sgx3Dsrv_ResetLinkPrms(chains_ov490VipMultiCam_Sgx3DsrvObj *pObj){
...
Void chains_ov490VipMultiCam_Sgx3Dsrv_SetPrms(chains_ov490VipMultiCam_Sgx3DsrvObj *pObj){
...
Void chains_ov490VipMultiCam_Sgx3Dsrv_ConnectLinks(chains_ov490VipMultiCam_Sgx3DsrvObj *pObj){
...
Int32 chains_ov490VipMultiCam_Sgx3Dsrv_Create(chains_ov490VipMultiCam_Sgx3DsrvObj *pObj, Void *appObj){

       Int32 status;

       chains_ov490VipMultiCam_Sgx3Dsrv_SetLinkId(pObj);
       chains_ov490VipMultiCam_Sgx3Dsrv_ResetLinkPrms(pObj);

       chains_ov490VipMultiCam_Sgx3Dsrv_SetPrms(pObj);
       chains_ov490VipMultiCam_Sgx3Dsrv_SetAppPrms(pObj, appObj);

       chains_ov490VipMultiCam_Sgx3Dsrv_ConnectLinks(pObj);
...
Int32 chains_ov490VipMultiCam_Sgx3Dsrv_Start(chains_ov490VipMultiCam_Sgx3DsrvObj *pObj){
...
Int32 chains_ov490VipMultiCam_Sgx3Dsrv_Stop(chains_ov490VipMultiCam_Sgx3DsrvObj *pObj){
...
Int32 chains_ov490VipMultiCam_Sgx3Dsrv_Delete(chains_ov490VipMultiCam_Sgx3DsrvObj *pObj){
...
Void chains_ov490VipMultiCam_Sgx3Dsrv_printBufferStatistics(chains_ov490VipMultiCam_Sgx3DsrvObj *pObj){
...
Void chains_ov490VipMultiCam_Sgx3Dsrv_printStatistics(chains_ov490VipMultiCam_Sgx3DsrvObj *pObj){
