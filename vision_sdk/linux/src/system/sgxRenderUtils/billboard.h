...
/*draw functions*/
void billboard_draw(float boxes[][24], Point3D_f base[],  UInt32 numBoxes, Pose3D_f *pose_ew, Pose3D_f *poses_cw, GLuint *texYuv);
void distance_info_draw(Point3D_f base[],  UInt32 numBoxes, Pose3D_f *pose, float dists[]);
