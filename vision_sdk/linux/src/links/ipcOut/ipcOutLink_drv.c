 ...
 *******************************************************************************
 */
static Void IpcOutLink_drvTranslateSystemBufferPayloadPtrsVirt2Phys(System_Buffer *pBuffer)
{
    UInt32 planes = 0;
    UInt32 frames = 0;
...
static Void IpcOutLink_drvTranslateSystemBufferPayloadPtrsPhys2Virt(System_Buffer *pBuffer)
{
    UInt32 planes = 0;
    UInt32 frames = 0;
    System_VideoFrameBuffer * pVideoFrameBuffer                   = NULL;
                    ...
                    )
{
    ...
    IpcOutLink_drvTranslateSystemBufferPayloadPtrsVirt2Phys(pBuffer);
...
Int32 IpcOutLink_drvReleaseBuffers(IpcOutLink_Obj *pObj)
{
    ...
    while(queStatus == SYSTEM_LINK_STATUS_SOK)
    {
        while(1)
        {
            ...
            IpcOutLink_drvTranslateSystemBufferPayloadPtrsPhys2Virt(pBuffer);
